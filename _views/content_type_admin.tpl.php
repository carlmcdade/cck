...
if (!empty($row)) {
    ...
    $output .= '<details><summary class="bg-warning p-1">edit</summary><form><div style="margin-bottom:1rem" class="border container">';
    foreach ($row as $tr => $line) {
    ...
    if(is_array($line)){ 
             ...
             foreach($line as $line_key => $line_value){
                ...
                $button_1  .= '<input class="form-control-xs" style="" value="'.$line_value.'" />';
                $button_1 .= '</div>';
             ...
             $button_1 .= '</div>' ;
                        ...
                        $button_1 .= '<div class="row"><div class="col"><input title="'.''.'" type="text" style="margin:0;" class="form-control-xs" value="'.$line.'" />';
