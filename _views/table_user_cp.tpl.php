		...
		{  
			...
			if(isset($row[$td]))
			{
			    ...
			    case "0":
			    	   ...
			    	   $row[$td] = '<a role="button"  class="btn btn-primary" href="?users/users_control_panel/'. $id .'">' .$row[$td]. '</a>' ;

			    	break;
			    case "1":
			    	   $row[$td] = '<a role="button"  class="btn btn-primary" href="?users/users_profile/'. $id .'">' .$row[$td]. '</a>' ;
			    	break;
			    }
