...
if (!empty($rows)) {
    ...
    foreach ($contentTypeFields as $field_key => $field_name) {
        if (isset($field_key)) {
            ...
            $output .= '<input value= "'. $field_name.'" type="hidden" class="form-control" id="content-type-fields" name="content_type_fields['.$field_key.'][]">' . "\n";
            $output .= '<input value= "'. $field_value.'" type="hidden" class="form-control" id="content-type-fields" name="content_type_fields['.$field_key.']['.$field_key.'][label][]" />' . "\n";
