...
if (!empty($rows)) {
    ...
    $output .= '<tr><td id="td-' . (isset($id) ? $id : '')  . $row['name'] . '-' .  $row['name'] .
					 ...
					 <button title="Requires Logged in User Permissions" class="btn btn-secondary" type="submit" formaction="?users/calendar_event_add/'.
                     $contentTypeId.'">Add Event</button>'."\n".'
					 </td></tr>' . "\n";
